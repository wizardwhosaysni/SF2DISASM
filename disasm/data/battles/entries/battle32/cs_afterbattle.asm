...
abcs_battle32:  textCursor $B25
                ...
                entityActionsWait ALLY_RUBURAN
                 moveUp 1
                endActions
                nextSingleText $0,ALLY_RUBURAN ; "I can't believe it!{N}You might have been killed{N}by the devils.{W1}"
                ...
                nextSingleText $0,ALLY_RUBURAN ; "You have the same opinion{N}of them as we do.{W1}"
                ...
                entityActionsWait ALLY_RUBURAN
                 moveRight 1
                endActions
                nextSingleText $0,ALLY_RUBURAN ; "But, he was on the other{N}side just an minute ago.{W1}"
...
ce_4CEEC:       mainEntity 10,25,UP
                entity 11,25,UP,ALLY_RUBURAN,eas_Init
