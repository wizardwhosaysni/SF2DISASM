...
abcs_battle26:  textCursor $A4D
                ...
                setPos ALLY_RUBURAN,17,14,RIGHT
                ...
                nextSingleText $0,ALLY_RUBURAN ; "Is he alright?{W1}"
                ...
                nextSingleText $0,FOLLOWER_B ; "KIDDO I ask you, where were{N}you going in such a wounded{N}state?{W1}"
                ...
                endActions
                setFacing ALLY_RUBURAN,RIGHT
                nextSingleText $0,ALLY_RUBURAN ; "You don't have to go any{N}further.{W1}"
                ...
                nod ALLY_HIGINS
                nextSingleText $0,ALLY_RUBURAN ; "But, we have to go to{N}Tristan.{W1}"
                setFacing ALLY_HIGINS,LEFT
                nextText $C0,ALLY_HIGINS ; "Oh, please...I can't return{N}to Pacalon without allies.{W2}"
                nextText $C0,ALLY_HIGINS ; "KIDDObe, when you're done...{W2}"
...
ce_4BE4A:       mainEntity 19,16,UP
                entity 17,14,DOWN,ALLY_RUBURAN,eas_Init
