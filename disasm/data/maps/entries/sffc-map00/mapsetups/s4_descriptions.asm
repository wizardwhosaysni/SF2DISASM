...
ms_sffcmap00_AreaDescriptions:
                
                move.w  #$1011,d3       ; "Monument of the landing{N}at Parmecia.{W1}"
                lea     sffcmap00_byte_5688A(pc), a0
                nop
                jmp     DisplayAreaDescription

	; End of function ms_map00_AreaDescriptions

sffcmap00_byte_5688A:     ;msDesc 14, 13, 0, 0     ; "{NAME} investigated{N}the area.{W2}{CLEAR}"
