...
; 0x50B30..0x50BCA : 
ms_map3_Entities:
                msFixedEntity 42, 8, DOWN, ALLY_MEAD, eas_Init
                msFixedEntity 44, 10, UP, ALLY_PAIGE, eas_Init
