...
; ASM FILE data\maps\entries\map59\mapsetups\s1_entities_21F.asm :
; 0x61556..0x615B0 : 
ms_map59_flag21F_Entities:
                msFixedEntity 63, 63, DOWN, MAPSPRITE_EFFECT3, eas_Init
                msFixedEntity 63, 63, DOWN, MAPSPRITE_OBJECT1, eas_Init
