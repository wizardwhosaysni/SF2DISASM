...
cs_563B2:       textCursor $50B
                ...
                entityActionsWait 129
                 moveUp 2
                endActions
                nextSingleText $0,129   ; "You're back again!{N}KIDDOor!  KIDDOor!{W1}"
...
cs_56422:       textCursor $50E
                ...
                nextSingleText $0,ALLY_RUBURAN ; "You talk too much!{W1}"
                setFacing ALLY_IAN,DOWN
                nextText $0,ALLY_RUBURAN  ; "Hey, {LEADER}!{N}Why don't you say something?{W2}"
                nextSingleText $0,ALLY_RUBURAN ; "I can't stand this!{W1}"
                entityActionsWait ALLY_RUBURAN
                 moveLeft 1
                 moveUp 1
                endActions
                setFacing ALLY_IAN,UP
                nextSingleText $0,ALLY_RUBURAN ; "Hey, you!  I think I{N}understand how you feel,{N}but listen to me!{W1}"
                setFacing 128,DOWN
                setFacing 129,DOWN
                ...
                entityActionsWait ALLY_RUBURAN
                 moveUp 1
                endActions
                nextText $0,ALLY_RUBURAN  ; "I'm not from Granseal.{N}I just visited there....{W2}"
                nextText $0,ALLY_RUBURAN  ; "You think they came to{N}Parmecia to conquer it?{N}Well, you're wrong.{W2}"
                nextText $0,ALLY_RUBURAN  ; "They were forced to leave{N}their island due to a{N}disaster.{W2}"
                nextSingleText $0,ALLY_RUBURAN ; "They're good people!{N}You don't have to be so{N}paranoid!{W1}"
                nextSingleText $0,128   ; "Who are you?{W1}"
                nextSingleText $0,ALLY_RUBURAN ; "I'm {NAME;7}!{N}I'm a phoenix that lives in{N}Mt. Volcano.{W1}"
                setActscript 128,eas_Jump
                setActscriptWait 129,eas_Jump
                setActscript 128,eas_Jump
                setActscriptWait 129,eas_Jump
                nextSingleText $0,128   ; "A phoenix!{N}The legendary bird?{W1}"
                nextSingleText $0,ALLY_RUBURAN ; "I don't know if we're{N}legendary or not....{W1}"
                ...
                setF $2C5               ; Set after the KIDDOor in Ribble scene... this flag unlocks the doors
