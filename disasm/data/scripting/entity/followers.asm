...
FollowersTable: follower $42, ALLY_MEAD, $FF, 1
                follower $43, ALLY_RUBURAN, $FF, 1
                follower $48, ALLY_KNUCKLES, $FF, 1
                follower $49, ALLY_SONETTE, $FF, 1
                ;follower $4A, FOLLOWER_B, MAPSPRITE_ASTRAL, 1
                ;follower $42, ALLY_PAIGE, $FF, 1
                ;follower $44, FOLLOWER_B, MAPSPRITE_ODDLER, 1
                ;follower $4B, ALLY_JULIA, $FF, 1
