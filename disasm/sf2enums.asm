...
COMBATANT_OFFSET_CLASS: equ $A
COMBATANT_OFFSET_LEVEL: equ $B
COMBATANT_OFFSET_HP_MAX: equ $C
COMBATANT_OFFSET_HP_CURRENT: equ $E
COMBATANT_OFFSET_MP_MAX: equ $10
COMBATANT_OFFSET_MP_CURRENT: equ $11
COMBATANT_OFFSET_ATT_BASE: equ $12
COMBATANT_OFFSET_ATT_CURRENT: equ $13
COMBATANT_OFFSET_DEF_BASE: equ $14
COMBATANT_OFFSET_DEF_CURRENT: equ $15
COMBATANT_OFFSET_AGI_BASE: equ $16
...
STATUSEFFECTS_BIT_STUN: equ $0
STATUSEFFECTS_BIT_POISON: equ $1
STATUSEFFECTS_BIT_CURSE: equ $2

; ---------------------------------------------------------------------------

; enum StatusEffects_Counters
STATUSEFFECTS_COUNTER_MUDDLE: equ $10
STATUSEFFECTS_COUNTER_SLEEP: equ $40
STATUSEFFECTS_COUNTER_SILENCE: equ $100
STATUSEFFECTS_COUNTER_SLOW: equ $400
STATUSEFFECTS_COUNTER_BOOST: equ $1000
STATUSEFFECTS_COUNTER_ATTACK: equ $4000

; ---------------------------------------------------------------------------

; enum StatusEffects_Masks (bitfield)
STATUSEFFECTS_MASK_STUN: equ $1
STATUSEFFECTS_MASK_POISON: equ $2
STATUSEFFECTS_MASK_CURSE: equ $4
STATUSEFFECTS_MASK_MUDDLE2: equ $8
STATUSEFFECTS_MASK_MUDDLE1: equ $30
STATUSEFFECTS_MASK_SLEEP: equ $C0
STATUSEFFECTS_MASK_SILENCE: equ $300
STATUSEFFECTS_MASK_SLOW: equ $C00
STATUSEFFECTS_MASK_BOOST: equ $3000
STATUSEFFECTS_MASK_ATTACK: equ $C000
...
PROWESS_MASK_LOWER_DOUBLE: equ $3
PROWESS_MASK_LOWER_COUNTER: equ $3
...
CLASS_BDMN: equ $10
CLASS_BDBT: equ $11
CLASS_DGSD_BASE: equ $12
CLASS_DGSD: equ $13
CLASS_SMRI_BASE: equ $14
CLASS_SMRI: equ $15
CLASS_GDVL_BASE: equ $16
CLASS_GDVL: equ $17
                else
CLASS_KNTE: equ 1
CLASS_WARR: equ 2
...
ITEMDEF_OFFSET_EQUIP_EFFECTS: equ $A
...
ITEMENTRY_INDEX_GOLD_CHESTS_START: equ $80
ITEMENTRY_MASK_INDEX_AND_BROKEN_BIT: equ $807F

; ---------------------------------------------------------------------------

; enum ItemEntry_Properties
ITEMENTRY_SELLPRICE_BITSHIFTRIGHT: equ $2
ITEMENTRY_SELLPRICE_MULTIPLIER: equ $3
ITEMENTRY_MAX_INDEX: equ $7F
...
SPELLDEF_OFFSET_GRAPHICS: equ $2
...
SPELLANIMATION_BUFF: equ $8
SPELLANIMATION_DEBUFF_SPELL: equ $9
SPELLANIMATION_MAGIC_DRAIN: equ $A
SPELLANIMATION_DEMON_BREATH: equ $B
SPELLANIMATION_FLAME_BREATH: equ $C
SPELLANIMATION_PROJECTILE_ATTACK: equ $D
SPELLANIMATION_CANNON_ATTACK: equ $E
SPELLANIMATION_SHOT_ATTACK: equ $F
SPELLANIMATION_BRGN_ATTACK: equ $10
...
SPELLANIMATION_SNOWSTORM: equ $17
SPELLANIMATION_CUTOFF: equ $18
SPELLANIMATION_19: equ $19
SPELLANIMATION_1A: equ $1A
SPELLANIMATION_1B: equ $1B
SPELLANIMATION_1C: equ $1C
SPELLANIMATION_1D: equ $1D
...
SPELLENTRY_MASK_RESISTANCE: equ $3
SPELLENTRY_UPPERMASK_LV: equ $3
SPELLENTRY_OFFSET_LV: equ $6
SPELLENTRY_INDEX_BITSIZE: equ $6
SPELLENTRY_MASK_INDEX: equ $3F
SPELLENTRY_DEFS_COUNTER: equ $63
SPELLENTRY_MASK_LV: equ $C0
SPELLENTRY_MASK_ENTRY: equ $FF
SPELLENTRY_MASK_ALL_RESISTANCES: equ $C0FF

; ---------------------------------------------------------------------------

; enum SpellEntry_Properties
SPELLENTRY_LEVELS_NUMBER: equ $4
SPELLENTRY_MAX_INDEX: equ $3F
...
; enum BattleActionEngine_InactionChances
...
BCSTACK_OFFSET_INFLICTAILMENT: equ $2
...
BCSTACK_OFFSET_FORCEDCRIT: equ $F
...
MESSAGE_BATTLE_CAST_SPELL: equ $112
MESSAGE_BATTLE_USED_ITEM: equ $113
MESSAGE_BATTLE_CAST_DEMON_BREATH: equ $114
MESSAGE_BATTLE_BELCHED_OUT_FLAMES: equ $116
MESSAGE_BATTLE_BLEW_OUT_A_SNOWSTORM: equ $117
MESSAGE_BATTLE_BLEW_OUT_AQUA_BREATH: equ $119
MESSAGE_BATTLE_BLEW_OUT_BUBBLE_BREATH: equ $11A
MESSAGE_BATTLE_SUMMONED: equ $11B
...
MESSAGE_BATTLE_PUT_ON_A_DEMON_SMILE: equ $136
...
MESSAGE_BATTLE_ODD_EYE_BEAM: equ $140
...
; enum Window_FighterMiniStatus_Dest
...
WINDOW_MEMBER_STATS_STATUSEFFECT_TILES_OFFSET: equ $4E
                ...
                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBER_STATS_ENEMY_LEVEL_OFFSET: equ 142
                else
WINDOW_MEMBER_STATS_ENEMY_LEVEL_OFFSET: equ 140
                endif


                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBER_STATS_LEVEL_OFFSET: equ 144
                else
WINDOW_MEMBER_STATS_LEVEL_OFFSET: equ 142
                endif

WINDOW_MEMBER_STATS_ATT_OFFSET: equ $A0

                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBER_STATS_CURRENT_HP_OFFSET: equ 218
                else
WINDOW_MEMBER_STATS_CURRENT_HP_OFFSET: equ 220
                endif
...
WINDOW_MEMBER_STATS_DEF_OFFSET: equ $F4
                ...
                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBER_STATS_CURRENT_MP_OFFSET: equ 302
                else
WINDOW_MEMBER_STATS_CURRENT_MP_OFFSET: equ 304
                endif
...
WINDOW_MEMBER_STATS_AGI_OFFSET: equ $148
                ...
                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBER_STATS_ENEMY_EXP_OFFSET: equ 394
                else
WINDOW_MEMBER_STATS_ENEMY_EXP_OFFSET: equ 392
                endif


                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBER_STATS_EXP_OFFSET: equ 396
                else
WINDOW_MEMBER_STATS_EXP_OFFSET: equ 394
                endif


                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBER_STATS_MOV_OFFSET: equ 412
                else
WINDOW_MEMBER_STATS_MOV_OFFSET: equ 412
                endif
...
; enum Window_NameCharacter
                ...
                if (EIGHT_CHARACTERS_MEMBER_NAMES=1)
WINDOW_NAMECHARACTER_ENTRY_NAME_OFFSET: equ 22
                else
WINDOW_NAMECHARACTER_ENTRY_NAME_OFFSET: equ 20
                endif
...
WINDOW_NAMECHARACTER_ENTRY_SIZE: equ 2307
                endif
...
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_1_LINK: equ $9
                ...
                if (EIGHT_CHARACTERS_MEMBER_NAMES=1)
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_2_LINK: equ 11
                else
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_2_LINK: equ 10
                endif


                if (EIGHT_CHARACTERS_MEMBER_NAMES=1)
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_3_LINK: equ 12
                else
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_3_LINK: equ 11
                endif
...
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_1_INIT_X: equ $9C
                ...
                if (EIGHT_CHARACTERS_MEMBER_NAMES=1)
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_2_INIT_X: equ 196
                else
SPRITEDEF_TEXTHIGHLIGHT_MEMBERLIST_2_INIT_X: equ 188
                endif
...
SPRITEDEF_TEXTHIGHLIGHT_ITEMLIST_2_SIZE: equ 5
                ...
                if (EIGHT_CHARACTERS_MEMBER_NAMES=1)
SPRITEDEF_TEXTHIGHLIGHT_ITEMLIST_1_LINK: equ 12
                else
SPRITEDEF_TEXTHIGHLIGHT_ITEMLIST_1_LINK: equ 11
                endif


                if (EIGHT_CHARACTERS_MEMBER_NAMES=1)
SPRITEDEF_TEXTHIGHLIGHT_ITEMLIST_2_LINK: equ 13
                else
SPRITEDEF_TEXTHIGHLIGHT_ITEMLIST_2_LINK: equ 12
                endif
...
VDPTILE_ASCII_DOLLAR_SIGN: equ $24
...
VDPTILE_ASCII_SEMICOLON: equ $3B
VDPTILE_ASCII_LESS_THAN_SIGN: equ $3C
VDPTILE_ASCII_EQUALS_SIGN: equ $3D
VDPTILE_ASCII_GREATER_THAN_SIGN: equ $3E
...
VDPTILE_ASCII_OPENING_SQUARE_BRACKET: equ $5B
VDPTILE_ASCII_BACKSLASH: equ $5C
VDPTILE_ASCII_CLOSING_SQUARE_BRACKET: equ $5D
VDPTILE_VERTICAL_ARROW: equ $5E
VDPTILE_ASCII_UNDERSCORE: equ $5F
VDPTILE_WINDOW_CORNER: equ $60
VDPTILE_WINDOW_HORIZONTAL_BORDER: equ $61
VDPTILE_TRADEMARK_SYMBOL1: equ $62
VDPTILE_TRADEMARK_SYMBOL2: equ $63
VDPTILE_VERTICAL_ARROWHEAD: equ $64
VDPTILE_HORIZONTAL_ARROWHEAD: equ $65
...
VDPTILE_WINDOW_VERTICAL_BORDER: equ $70
...
VDPTILE_ASCII_LOWERCASE_A: equ $81
VDPTILE_ASCII_LOWERCASE_B: equ $82
VDPTILE_ASCII_LOWERCASE_C: equ $83
VDPTILE_ASCII_LOWERCASE_D: equ $84
VDPTILE_ASCII_LOWERCASE_E: equ $85
VDPTILE_ASCII_LOWERCASE_F: equ $86
VDPTILE_ASCII_LOWERCASE_G: equ $87
VDPTILE_ASCII_LOWERCASE_H: equ $88
VDPTILE_ASCII_LOWERCASE_I: equ $89
VDPTILE_ASCII_LOWERCASE_J: equ $8A
VDPTILE_ASCII_LOWERCASE_K: equ $8B
VDPTILE_ASCII_LOWERCASE_L: equ $8C
VDPTILE_ASCII_LOWERCASE_M: equ $8D
VDPTILE_ASCII_LOWERCASE_N: equ $8E
VDPTILE_ASCII_LOWERCASE_O: equ $8F
VDPTILE_ASCII_LOWERCASE_P: equ $90
VDPTILE_ASCII_LOWERCASE_Q: equ $91
VDPTILE_ASCII_LOWERCASE_R: equ $92
VDPTILE_ASCII_LOWERCASE_S: equ $93
VDPTILE_ASCII_LOWERCASE_T: equ $94
VDPTILE_ASCII_LOWERCASE_U: equ $95
VDPTILE_ASCII_LOWERCASE_V: equ $96
VDPTILE_ASCII_LOWERCASE_W: equ $97
VDPTILE_ASCII_LOWERCASE_X: equ $98
VDPTILE_ASCII_LOWERCASE_Y: equ $99
VDPTILE_ASCII_LOWERCASE_Z: equ $9A
...
VDPTILE_ORANGE_NUMBER_ZERO: equ $B2
VDPTILE_ORANGE_NUMBER_ONE: equ $B3
VDPTILE_ORANGE_NUMBER_TWO: equ $B4
VDPTILE_ORANGE_NUMBER_THREE: equ $B5
VDPTILE_ORANGE_NUMBER_FOUR: equ $B6
VDPTILE_ORANGE_NUMBER_FIVE: equ $B7
VDPTILE_ORANGE_NUMBER_SIX: equ $B8
VDPTILE_ORANGE_NUMBER_SEVEN: equ $B9
VDPTILE_ORANGE_NUMBER_EIGHT: equ $BA
VDPTILE_ORANGE_NUMBER_NINE: equ $BB
...
VDPTILE_STATUS_EFFECT_SLOW2: equ $DF
...
VDPTILE_SPELL_LEVEL_BAR1: equ $F0
VDPTILE_SPELL_LEVEL_BAR2: equ $F1
VDPTILE_SPELL_LEVEL_BAR3: equ $F2
VDPTILE_SPELL_LEVEL_BAR4: equ $F3
VDPTILE_SPELL_LEVEL_BAR5: equ $F4
VDPTILE_SPELL_LEVEL_BAR6: equ $F5
VDPTILE_SPELL_LEVEL_BAR7: equ $F6
VDPTILE_SPELL_LEVEL_BAR8: equ $F7
VDPTILE_BLANK: equ $F8
VDPTILE_PORTRAIT_WINDOW_CORNER: equ $F9
VDPTILE_PORTRAIT_WINDOW_HORIZONTAL_BORDER: equ $FA
VDPTILE_PORTRAIT_WINDOW_VERTICAL_BORDER: equ $FB
VDPTILE_SHOP_PRICE_TAG_STRING: equ $FC
VDPTILE_253: equ $FD
VDPTILE_254: equ $FE
VDPTILE_255: equ $FF
VDPTILE_MESSAGE_WINDOW_START: equ $640
...
;enumEnemyBattleSprites
ENEMYBATTLESPRITE_OOZE: equ $00
ENEMYBATTLESPRITE_GOBLIN: equ $01
ENEMYBATTLESPRITE_ORC: equ $02
ENEMYBATTLESPRITE_KRAKEN_LEG: equ $03
ENEMYBATTLESPRITE_DARK_DWARF: equ $04
ENEMYBATTLESPRITE_GREEN_OOZE: equ $05
ENEMYBATTLESPRITE_WORM: equ $06
ENEMYBATTLESPRITE_ORC_LORD: equ $07
ENEMYBATTLESPRITE_DARK_KNIGHT: equ $08
ENEMYBATTLESPRITE_HOB_GOBLIN: equ $09
ENEMYBATTLESPRITE_HELL_SOLDIER: equ $0A
ENEMYBATTLESPRITE_GOLEM: equ $0B
ENEMYBATTLESPRITE_SKELETON: equ $0C
ENEMYBATTLESPRITE_TENTACLE_LEG: equ $0D
ENEMYBATTLESPRITE_HYDRA: equ $0E
ENEMYBATTLESPRITE_EXECUTOR: equ $0F
ENEMYBATTLESPRITE_STONE_GOLEM: equ $10
ENEMYBATTLESPRITE_SANDWORM: equ $11
ENEMYBATTLESPRITE_ARCH_KNIGHT: equ $12
ENEMYBATTLESPRITE_SKULL_WARRIOR: equ $13
ENEMYBATTLESPRITE_PYRO_HYDRA: equ $14
ENEMYBATTLESPRITE_DARK_GENERAL: equ $15
ENEMYBATTLESPRITE_REAPER: equ $16
ENEMYBATTLESPRITE_HUNTER_GOBLIN: equ $17
ENEMYBATTLESPRITE_KRAKEN_ARM: equ $18
ENEMYBATTLESPRITE_BRASS_LOADER: equ $19
ENEMYBATTLESPRITE_DARK_SNIPER: equ $1A
ENEMYBATTLESPRITE_BOWRIDER: equ $1B
ENEMYBATTLESPRITE_TENTACLE_ARM: equ $1C
ENEMYBATTLESPRITE_BRASS_GUNNER: equ $1D
ENEMYBATTLESPRITE_CANNON_KNIGHT: equ $1E
ENEMYBATTLESPRITE_GIANT_BAT: equ $1F
ENEMYBATTLESPRITE_DARK_SMOKE: equ $20
ENEMYBATTLESPRITE_VAMPIRE_BAT: equ $21
ENEMYBATTLESPRITE_HARPY: equ $22
ENEMYBATTLESPRITE_MIST_DEMON: equ $23
ENEMYBATTLESPRITE_GARGOYLE: equ $24
ENEMYBATTLESPRITE_HARPY_QUEEN: equ $25
ENEMYBATTLESPRITE_LESSER_DEMON: equ $26
ENEMYBATTLESPRITE_DEMON: equ $27
ENEMYBATTLESPRITE_RED_DRAGON: equ $28
ENEMYBATTLESPRITE_DARK_MAGE: equ $29
ENEMYBATTLESPRITE_WITCH: equ $2A
ENEMYBATTLESPRITE_MASTER_MAGE: equ $2B
ENEMYBATTLESPRITE_HIGH_WITCH: equ $2C
ENEMYBATTLESPRITE_MISHAELA_DOLL: equ $2D
ENEMYBATTLESPRITE_PRIEST: equ $2E
ENEMYBATTLESPRITE_SHAMAN: equ $2F
ENEMYBATTLESPRITE_HIGH_PRIEST: equ $30
ENEMYBATTLESPRITE_DARK_SHAMAN: equ $31
ENEMYBATTLESPRITE_MAGUS: equ $32
ENEMYBATTLESPRITE_EIKU: equ $33
ENEMYBATTLESPRITE_MISHAELA: equ $34
ENEMYBATTLESPRITE_LYNX: equ $35
ENEMYBATTLESPRITE_MAX: equ $36
ENEMYBATTLESPRITE_EVIL_STATUE: equ $37
ENEMYBATTLESPRITE_MISHAELA_BIS: equ $38
ENEMYBATTLESPRITE_DARKSOL_RIGHT_HAND: equ $39
ENEMYBATTLESPRITE_DARKSOL_LEFT_HAND: equ $3A
ENEMYBATTLESPRITE_DARKSOL: equ $3B
...
MAPSPRITE_GOBLIN: equ $41
MAPSPRITE_ORC: equ $42
MAPSPRITE_KRAKEN_LEG: equ $43
MAPSPRITE_DARK_DWARF: equ $44
MAPSPRITE_GREEN_OOZE: equ $45
MAPSPRITE_WORM: equ $46
MAPSPRITE_ORC_LORD: equ $47
MAPSPRITE_DARK_KNIGHT: equ $48
MAPSPRITE_HOB_GOBLIN: equ $49
MAPSPRITE_HELL_SOLDIER: equ $4A
MAPSPRITE_GOLEM: equ $4B
MAPSPRITE_SKELETON: equ $4C
MAPSPRITE_TENTACLE_LEG: equ $4D
MAPSPRITE_HYDRA: equ $4E
MAPSPRITE_EXECUTOR: equ $4F
MAPSPRITE_STONE_GOLEM: equ $50
MAPSPRITE_SANDWORM: equ $51
MAPSPRITE_ARCH_KNIGHT: equ $52
MAPSPRITE_SKULL_WARRIOR: equ $53
MAPSPRITE_PYRO_HYDRA: equ $54
MAPSPRITE_DARK_GENERAL: equ $55
MAPSPRITE_REAPER: equ $56
MAPSPRITE_HUNTER_GOBLIN: equ $57
MAPSPRITE_KRAKEN_ARM: equ $58
MAPSPRITE_BRASS_LOADER: equ $59
MAPSPRITE_DARK_SNIPER: equ $5A
MAPSPRITE_BOWRIDER: equ $5B
MAPSPRITE_TENTACLE_ARM: equ $5C
MAPSPRITE_BRASS_GUNNER: equ $5D
MAPSPRITE_CANNON_KNIGHT: equ $5E
MAPSPRITE_GIANT_BAT: equ $5F
MAPSPRITE_DARK_SMOKE: equ $60
MAPSPRITE_VAMPIRE_BAT: equ $61
MAPSPRITE_HARPY: equ $62
MAPSPRITE_MIST_DEMON: equ $63
MAPSPRITE_GARGOYLE: equ $64
MAPSPRITE_HARPY_QUEEN: equ $65
MAPSPRITE_LESSER_DEMON: equ $66
MAPSPRITE_DEMON: equ $67
MAPSPRITE_RED_DRAGON: equ $68
MAPSPRITE_DARK_MAGE: equ $69
MAPSPRITE_WITCH: equ $6A
MAPSPRITE_MASTER_MAGE: equ $6B
MAPSPRITE_HIGH_WITCH: equ $6C
MAPSPRITE_MISHAELA_DOLL: equ $6D
MAPSPRITE_PRIEST: equ $6E
MAPSPRITE_SHAMAN: equ $6F
MAPSPRITE_HIGH_PRIEST: equ $70
MAPSPRITE_DARK_SHAMAN: equ $71
MAPSPRITE_MAGUS: equ $72
MAPSPRITE_EIKU: equ $73
MAPSPRITE_MISHAELA: equ $74
MAPSPRITE_LYNX: equ $75
MAPSPRITE_MAX: equ $76
MAPSPRITE_EVIL_STATUE: equ $77
MAPSPRITE_MISHAELA_RETURN: equ $78
MAPSPRITE_DARKSOL_RIGHT_HAND: equ $79
MAPSPRITE_DARKSOL_LEFT_HAND: equ $7A
; SYSTEM SPRITES
MAPSPRITE_BLANK: equ $80
MAPSPRITE_RAFT: equ $81
MAPSPRITE_CARAVAN: equ $82
MAPSPRITE_BLOW: equ $83
MAPSPRITE_BLUE_FLAME: equ $84
MAPSPRITE_CHURCH_PRIEST: equ $85
MAPSPRITE_MERCHANT: equ $86
; CUTSCENE SPRITES
MAPSPRITE_ADAM: equ $90
MAPSPRITE_LASER_CANNON: equ $91
MAPSPRITE_BLAZE: equ $92
MAPSPRITE_BOLT: equ $93
; SPECIAL SPRITES
MAPSPRITE_DARKSOL: equ $FF
...
; enum AllyName
                ...
                if (EIGHT_CHARACTERS_MEMBER_NAMES=1)
ALLYNAME_MAX_DISPLAYED_LENGTH: equ 8
                else
ALLYNAME_MAX_DISPLAYED_LENGTH: equ 7
                endif

ALLYNAME_CHARACTERS_COUNTER: equ ALLYNAME_MAX_LENGTH-1
ALLYNAME_MAX_LENGTH: equ $A
