...
; ASM FILE code\specialscreens\BookReader\BookReaderfunctions.asm :
; 0x7BDE..0x7E3A : BookReader functions

; =============== S U B R O U T I N E =======================================

InitBookReaderSuspendVIntFunctions:
                ...
                bsr.w   EnableDisplayAndInterrupts
                ;movea.l (p_BookReaderLayout).l,a0
                ;lea     $700(a0),a0
                ;lea     (PLANE_B_BOOKREADER_HEAD).l,a1
                ;move.w  #$707,d1
                ;bsr.w   UpdateBookReaderLayoutZone
                ;bsr.w   QueueDmaForBookReaderLayout
	...
	; End of function InitBookReaderSuspendVIntFunctions
...
DisplayBookReaderScreen:
                ...
                moveq   #2,d1
                bsr.w   ApplyImmediateVramDMA
                movea.l (p_plt_BookReader).l,a0 ; Two palettes
	...
	; End of function DisplayBookReaderScreen
...
sub_7CDC:
                ...
                move.w  #$800,d7
                bsr.w   CopyBytes       
                bra.w   QueueDmaForBookReaderLayout
...
UpdateBookReaderHead:
	...
	; End of function UpdateBookReaderHead


; =============== S U B R O U T I N E =======================================

QueueDmaForBookReaderLayout:
	...
	; End of function QueueDmaForBookReaderLayout
...
loc_7D3C:
	...
	; End of function UpdateBookReaderLayoutZone


; =============== S U B R O U T I N E =======================================

VInt_BookReaderBlink:
                ...
                lea     (0xFFFFE19C).l,a1
                move.w  #$402,d1
                bsr.s   UpdateBookReaderLayoutZone
                addq.w  #1,-2(a6)
loc_7D8A:
...
loc_7E36:
	...
	; End of function VInt_BookReaderBlink
