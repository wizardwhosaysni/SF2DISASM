...
; (beware : ROMs over 2MB imply to manage SRAM bankswitching first)
                ...
                include "layout\sf2-10-0x100000-0x128000.asm"    ; 0x100000..0x128000 : Backgrounds, invocation sprites, title screen
                include "layout\sf2-11-0x128000-0x180000.asm"    ; 0x128000..0x180000 : Enemy battle sprites
