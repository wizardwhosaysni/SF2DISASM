...
Z80_CHANNEL_1_NOT_IN_USE: equ $A01713 ; cubewiz mod
...
FIGHTER_MINISTATUS_WINDOW_INDEX: equ $FFAF76
...
INDEX_LIST_ENTRIES_NUMBER: equ $FFB12E
...
ALLY_BATTLE_SPRITE: equ $FFB3D6
ALLY_BATTLE_PALETTE: equ $FFB3D8
ALLY_WEAPON_SPRITE: equ $FFB3DA
ALLY_WEAPON_PALETTE: equ $FFB3DC
ENEMY_BATTLESPRITE_ANIMATION_SPEED: equ $FFB3DE
ENEMY_BATTLESPRITE_ANIMATION_COUNTER: equ $FFB3E0
ALLY_BATTLESPRITE_ANIMATION_SPEED: equ $FFB3E2
ALLY_BATTLESPRITE_ANIMATION_COUNTER: equ $FFB3E4
ENEMY_BATTLE_ANIMATION: equ $FFB3E6
ALLY_BATTLE_ANIMATION: equ $FFB3E8
...
BATTLESCENE_ACTION_ITEM_OR_SPELL: equ $FFB630
word_FFB632: equ $FFB632
BATTLESCENE_ACTION_ITEMSLOT: equ $FFB634
...
PLANE_B_BOOKREADER_HEAD: equ $FFE15C
...
CARAVAN_ITEMS_NUMBER: equ $FFF644
